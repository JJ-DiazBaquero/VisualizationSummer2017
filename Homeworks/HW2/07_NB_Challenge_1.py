...
reader.SetFileName("D:\\Dropbox\\documentos\\Scientific Visualization\\06-20-2017\\SS_2017-master\\data\\jet4_0.500.vtk")
reader.Update()
...
for i in range(0,tableSize):
    rgb = list(colorTransferFunction.GetColor(float(i)/tableSize))+[1]
